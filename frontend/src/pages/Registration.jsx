    ...
    <div className="flex justify-center min-h-screen bg-black bg-cover bg-center">
      ...
      >
        ...
        {role === "candidate" && !loading && !success && (
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="hidden md:block">
              <motion.img src={log} alt="Candidate" initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="rounded-xl shadow-lg w-full max-h-[600px] object-contain" />
            </div>
        ...
        {role === "employer" && !loading && !success && (
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="hidden md:block">
              <motion.img src={png} alt="Employer" initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="rounded-xl shadow-lg w-full max-h-[600px] object-contain" />
            </div>
